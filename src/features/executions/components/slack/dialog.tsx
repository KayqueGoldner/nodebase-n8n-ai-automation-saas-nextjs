...
export type SlackDialogFormSchema = z.infer<typeof formSchema>;

interface SlackDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (values: SlackDialogFormSchema) => void;
  defaultValues?: Partial<SlackDialogFormSchema>;
}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      {...field}
                      placeholder="Summary: {{slackResponse.text}}"
