...
export type HttpRequestDialogFormSchema = z.infer<typeof formSchema>;
...
export const HttpRequestDialog = ({
  ...
  const handleSubmit = (values: HttpRequestDialogFormSchema) => {
    onSubmit(values);
    onOpenChange(false);
  };
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    ...
                    {watchVariableName && "{{" + watchVariableName + "}}"}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="https://api.example.com/endpoint/{{dynamicValue}}" {...field} />
                  </FormControl>
                  <FormDescription>
