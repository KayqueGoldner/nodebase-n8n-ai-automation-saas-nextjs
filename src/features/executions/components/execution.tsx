...
export const ExecutionView = ({ executionId }: ExecutionViewProps) => {
  ...
  const formattedStatus = execution.status.charAt(0).toUpperCase() + execution.status.slice(1).toLowerCase();
          ...
          <div className="mt-6 p-4 bg-red-50 rounded-md space-y-3">
            ...
            {execution.errorStack && (
              ...
              >
                ...
                <CollapsibleContent>
                  <pre className="text-xs text-red-800 font-mono mt-2 p-2 bg-red-100 rounded overflow-auto">
                    {execution.errorStack}
                  </pre>
                </CollapsibleContent>
              </Collapsible>
